...
SRC_DIR=$DIR/../..
GN=$SRC_DIR/bin/gn
OUTPUT_DIR=$SRC_DIR/out/iOS_arm64_Debug
DEST_DIR=$DEVENV/aiSDK/prebuilt/iOS_arm64_Debug
...
ninja -C out/iOS_arm64_Debug

mkdir -p $DEST_DIR/lib
cp $OUTPUT_DIR/*.a $DEST_DIR/lib
mv $DEVENV/aiSDK/prebuilt/iOS_arm64_Debug/lib/libzlib.a $DEST_DIR/lib/libz.a
