...
SRC_DIR=$DIR/../..
GN=$SRC_DIR/bin/gn
OUTPUT_DIR=$SRC_DIR/out/macOS_arm64_Release
DEST_DIR=$DEVENV/aiSDK/prebuilt/macOS_arm64_Release
...
ninja -C out/macOS_arm64_Release

mkdir -p $DEST_DIR/lib
cp $OUTPUT_DIR/*.a $DEST_DIR/lib
mv $DEVENV/aiSDK/prebuilt/macOS_arm64_Release/lib/libzlib.a $DEST_DIR/lib/libz.a
