...
SRC_DIR=$DIR/../..
GN=$SRC_DIR/bin/gn
OUTPUT_DIR=$SRC_DIR/out/macOS_arm64_Debug
DEST_DIR=$DEVENV/aiSDK/prebuilt/macOS_arm64_Debug
...
$DIR/../../bin/gn gen out/macOS_arm64_Debug --args='
...
ninja -C out/macOS_arm64_Debug

mkdir -p $DEST_DIR/lib
cp $OUTPUT_DIR/*.a $DEST_DIR/lib
mv $DEVENV/aiSDK/prebuilt/macOS_arm64_Debug/lib/libzlib.a $DEST_DIR/lib/libz.a
